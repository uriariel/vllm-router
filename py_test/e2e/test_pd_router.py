...
def pd_cluster(e2e_model: str):
    ...
    # Environment capability checks: require vllm_kernel and GPU backend
    try:
        import vllm_kernel  # noqa: F401
    except Exception as e:  # pragma: no cover - environment dependent
        pytest.fail(f"PD e2e requires vllm_kernel but it is not available: {e}")
